(() => {
  ...
  // ns-hugo-imp:/Users/jgonnermann/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/hugo-blox-builder/modules/blox-tailwind@v0.0.0-20250925205154-e9b31f8090c0/blox/shared/js/components/Icon.jsx
  ...
  // ns-hugo-imp:/Users/jgonnermann/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/hugo-blox-builder/modules/blox-tailwind@v0.0.0-20250925205154-e9b31f8090c0/blox/hero/component.jsx
  ...
  var HeroBlock = ({ content, design, id, icon_svg }) => {
    ...
    return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 pt-14 lg:px-8", id, children: /* @__PURE__ */ u2("div", { class: `mx-auto max-w-2xl ${paddingClasses}`, children: [
      ...
      /* @__PURE__ */ u2("div", { class: "text-center", children: [
        ...
        content.text && /* @__PURE__ */ u2("p", { class: "mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300", dangerouslySetInnerHTML: { __html: renderText(content.text) } }),
